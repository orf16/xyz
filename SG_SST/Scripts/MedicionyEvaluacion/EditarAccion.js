//Generar datetime
    ...
    //buscar Pasar informacion del formulario a la variable tempdata
     $(function () {
            ...
            $("#NuevoHall").click(function () {
                ...
                stringArray[19] = userInfo;
                stringArray[20] = $("#ListaOrigen option:selected").val();
                stringArray[21] = $("#Otro_Origen").val();

                var postData = { values: stringArray };

                $.ajax({
                    type: "POST",
                    url: "/Acciones/GuardarFormularioEd",
                    data: postData,
    ...
    $('#QuitarFirmaAud').click(function () {
        ...
        $.ajax({
            type: "POST",
            url: '/Acciones/QuitarImgAudEd',
            data: '{TempdataID: "' + userInfo + '" }',
            contentType: "application/json; charset=utf-8",
            cache: false,
            dataType: "json",
            success: function (result) {
    ...
    $(function () {
	    ...
	    $("#ActualizarAccion").bind("click", function () {
	        var onEventLaunchGuardar = new postActualizar();
    ...
    this.launchGuardar = function () {
        ...
        stringArray[17] = $("#Nombre_Responsable").val();
        stringArray[18] = $("#Cargo_Responsable").val();
        stringArray[19] = $("#Pk_Id_Accion").val();
        stringArray[20] = $("#Fecha_dil").val();
        stringArray[21] = $('input:radio[name="Estado"]:checked').val();
        stringArray[22] = $("#ListaOrigen option:selected").val();
        stringArray[23] = $("#Otro_Origen").val();
        ...
        var Accion = {
            ...
            Pk_Id_Accion: stringArray[19],
            Fecha_dil: stringArray[20],
            Estado: stringArray[21],
            Origen: stringArray[22],
            Otro_Origen: stringArray[23]
        };

        PopupPosition();
        $.ajax({
            type: "POST",
            url: '/Acciones/postActualizarEdicion',
            traditional: true,
            contentType: 'application/json; charset=utf-8',
...
function () {
    ...
    $.ajax({
        type: "POST",
        url: "/Acciones/EliminarActividadEd",
        data: '{values: "' + Id_Elm + '",id: "' + userInfo + '" }',
        contentType: "application/json; charset=utf-8",
        cache: false,
        dataType: "json",
        success: function (response) {
...
function () {
    ...
    $.ajax({
        type: "POST",
        url: "/Acciones/EliminarSeguimientoEd",
        data: '{values: "' + Id_Elm + '",id: "' + userInfo + '" }',
        contentType: "application/json; charset=utf-8",
        cache: false,
        dataType: "json",
...
function () {
    ...
    $.ajax({
        type: "POST",
        url: "/Acciones/EliminarHallazgoEd",
        data: '{values: "' + Id_Elm + '",id: "' + userInfo + '" }',
        contentType: "application/json; charset=utf-8",
        cache: false,
        dataType: "json",
    ...
    $(function () {
        $('#CancelarAccion').click(function () {
            ...
            swal({
                title: "Advertencia",
                text: "Estas seguro(a) que desea cancelar la edición de la acción?",
                showCancelButton: true,
                confirmButtonColor: "#DD6B55",
            ...
            function () {
                $.ajax({
                    type: "POST",
                    data: '{id: "' + userInfo + '" }',
                    url: "/Acciones/CancelarEditarAccion",
                    contentType: "application/json; charset=utf-8",
                    cache: false,
                    dataType: "json",
                    success: function (response) {
