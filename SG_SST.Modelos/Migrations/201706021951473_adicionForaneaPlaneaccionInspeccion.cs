namespace SG_SST.Models.Migrations
{
    ...
    public partial class adicionForaneaPlaneaccionInspeccion : DbMigration
    {
        public override void Up()
        {
            ...
            DropColumn("dbo.Tbl_Planeacion_Inspeccion", "Descripcion_Tipo_Inspeccion");
        }
        
        public override void Down()
        {
            AddColumn("dbo.Tbl_Planeacion_Inspeccion", "Descripcion_Tipo_Inspeccion", c => c.String());
