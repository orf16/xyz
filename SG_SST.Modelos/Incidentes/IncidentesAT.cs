...
{
     [Table("Tbl_IncidentesAT")]
    public class IncidentesAT
    {
         [Key]
         ...
         /// </summary>
         public bool Incidente { get; set; }///REQUERIDO
         ...
         public int pk_DepartamentoII { get; set; }///REQUERIDO
         public int pk_MunicipioII { get; set; }///REQUERIDO
