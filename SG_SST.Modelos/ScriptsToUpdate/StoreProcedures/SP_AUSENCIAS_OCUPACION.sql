...
ALTER PROCEDURE [dbo].[SP_AUSENCIAS_OCUPACION] (@anio int, @idOrigen int, @idEmpresaUsuaria int, @idSede int, @idDepartamento int, @nitEmpresa varchar(20))
AS
BEGIN
   ...
   declare @condicion2 VARCHAR(1000) = ' and a.FK_Id_Ausencias_Padre = 0 group by o.Descripcion_Ocupacion, DATEPART(MONTH,a.fechainicio)';
   declare @consulta VARCHAR(4000) = 'select '''''''' as Contingencia, isnull(o.Descripcion_Ocupacion, ''''No especificada'''') as Evento, 
									  ...
									  join Tbl_Ocupacion o on a.FK_Id_Ocupacion = o.PK_Ocupacion';
