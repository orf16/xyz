...
namespace SG_SST.ServiceRequest
{
    public class ServiceClient
    {
        ...
        /// <returns></returns>
        /// 
        public static T ObtenerObjetoJsonRestFul<T>(string urlBaseServicio, string nombreCapacidad, object objeto)
        {
            T respuesta;
            Uri baseUrl = new Uri(urlBaseServicio);
            var cliente = new RestClient
        ...
        /// <returns></returns>
        public static T[] RealizarPeticionesArrayPostJsonRestFul<T>(string urlBaseServicio, string nombreCapacidad, EDIncidente_Modelo_Consulta objeto)
        {
            T[] respuesta;
            Uri baseUrl = new Uri(urlBaseServicio);
            var cliente = new RestClient
        ...
        /// <param name="objeto"></param>
        /// <returns></returns>
        public static T[] RealizarPeticionesArrayPostJsonRest<T>(string urlBaseServicio, string nombreCapacidad, object objeto)
        {
            T[] respuesta;
            Uri baseUrl = new Uri(urlBaseServicio);
            var cliente = new RestClient
        ...
        /// <param name="objeto"></param>
        /// <returns></returns>
        public static Boolean PeticionesPostJsonRestFulRespuetaBool<T>(string urlBaseServicio, string nombreCapacidad, T objeto)
        {
            Boolean respuesta;
            Uri baseUrl = new Uri(urlBaseServicio);
            var cliente = new RestClient
        ...
        public static Boolean PeticionesPostJsonRestFulRespuetaBool(string urlBaseServicio, string nombreCapacidad, RestSharp.Method tipoPeticion)
        {
            Boolean respuesta;
            Uri baseUrl = new Uri(urlBaseServicio);
            var cliente = new RestClient
