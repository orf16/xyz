...
function postGuardar() {
    this.launchGuardar = function () {
        ...
        stringArray[0] = $("#Pk_Id_Programa").val();
        stringArray[1] = $("#Fk_Id_Sede").val();
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.Probar == false) {
                    ...
                    swal({
                        title: "Programa de auditorias actualizado exitosamente",
                        text: "",
                        type: "success",
