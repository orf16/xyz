...
ALTER PROCEDURE [dbo].[SP_AUSENCIAS_COSTO] (@anio int, @idOrigen int, @idEmpresaUsuaria int, @idSede int, @idDepartamento int, @nitEmpresa varchar(20))
AS
BEGIN
   ...
   declare @consulta VARCHAR(4000) = 'select c.Detalle as Contingencia , '''''''' as Evento, 
									  DATEPART(MONTH,a.fechainicio) as Mes, cast(sum(a.Costo) as decimal(19, 2)) as Total 
