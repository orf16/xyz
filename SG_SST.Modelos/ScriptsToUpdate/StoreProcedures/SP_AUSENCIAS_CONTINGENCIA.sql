...
ALTER PROCEDURE [dbo].[SP_AUSENCIAS_CONTINGENCIA] (@anio int, @idOrigen int, @idEmpresaUsuaria int, @idSede int, @idDepartamento int, @nitEmpresa varchar(20))
AS
BEGIN
   ...
   declare @condicion2 VARCHAR(1000) = ' order by c.Detalle, a.fechainicio';
   declare @consulta VARCHAR(4000) = 'select c.PK_Id_Contingencia as idContigencia, c.Detalle as Descripcion, a.fechainicio, a.Fecha_Fin as FechaFin
