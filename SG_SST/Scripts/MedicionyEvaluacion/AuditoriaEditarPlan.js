...
function postGuardar() {
    this.launchGuardar = function () {
        ...
        stringArray[1] = $("#Fk_Id_Proceso").val();
        ...
        stringArray[12] = $("#Pk_Id_Auditoria").val();

        // Construir objeto JSON
        var EDAuditorias = {
            Pk_Id_Auditoria: stringArray[12],
        ...
        $.ajax({
            type: "POST",
            url: '/Auditoria/EditarPlanAuditoria',
            traditional: true,
            ...
            success: function (data) {
                ...
                if (data.Probar == false) {
                    ...
                    swal({
                        title: "La Auditoria se ha editado correctamente",
                        text: "",
                        type: "success",
